...
# Script to pull latest Docker images and restart backend containers on EC2 instance
...
services:
  backend:
    ...
    environment:
      ...
      - PORT=8000
      - ALLOWED_ORIGINS=\${FRONTEND_URL:-https://reposage.vercel.app}
...
echo "Frontend is deployed on Vercel at: https://reposage.vercel.app" 